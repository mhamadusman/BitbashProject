        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto animate-slide-up">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="p-4 sm:p-6">
              {/* Input fields (title, company, etc.) */}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mt-4">
                ...
                <div className="space-y-2">
                  <input type="date" {...register('posting_date', { required: 'Posting date is required' })}
                  ...
                  />
                  {errors.posting_date && <p className="text-red-500 text-xs">{errors.posting_date.message}</p>}
                </div>
              </div>
              ...
              <div className="mt-4">
                <div className="space-y-2">
                  <select {...register('jobType', { required: 'Job type is required' })}
