...
const Footer = () => {
  return (
    <footer className="bg-black rounded-tl-3xl rounded-tr-3xl text-white py-0 lg:h-screen h-2/3 flex flex-col justify-between relative overflow-hidden">
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-between">
          ...
          <div className="w-full lg:w-auto flex-shrink-0 max-w-sm">
            ...
            <div className="flex flex-col w-full">
              ...
              <div className="relative mt-6 w-60 max-w-xl mx-auto">
                <button className="relative group w-full py-3 bg-transparent uppercase rounded-full text-gray-100 border border-green-300 focus:outline-none focus:ring-2 focus:ring-gray-400 transition-all duration-300 font-grotesk text-sm hover:text-gray-600 font-light flex justify-center items-center">
                  Subscribe
              ...
              <div
                className="text-[8rem]  lg:text-[22rem] font-bold text-gray-300 opacity-10 absolute inset-0 flex items-center justify-center select-none pointer-events-none tracking-tighter z-0"
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center border-t border-gray-700 opacity-35 mb-10 mt-6 pt-6 px-6 text-center lg:text-left">
          ...
          <div className="flex space-x-4 mt-4 lg:mt-0">
            <FaTwitter className="hover:text-green-500 cursor-pointer transition-colors duration-300" />
            <FaFacebookF className="hover:text-green-500cursor-pointer transition-colors duration-300" />
            <FaLinkedinIn className="hover:text-green-500 cursor-pointer transition-colors duration-300" />
            <FaYoutube className="hover:text-green-500 cursor-pointer transition-colors duration-300" />
          </div>
        </div>
      </div>
    </footer>
