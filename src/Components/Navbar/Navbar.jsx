...
const Navbar = ({
      ...
      <div className="mb-6">
        ...
        <div className="space-y-3 max-h-48 overflow-y-auto">
          {jobTypes.map((type) => (
            <label
              key={type}
              className="flex items-center justify-between cursor-pointer group hover:bg-[#4BCA7B]/5 p-2 rounded-lg transition-colors"
            >
  ...
  return (
    <>
          ...
          >
            ...
            <div className="flex items-center space-x-2 lg:hidden">
              <button
                ...
                className="p-2 rounded-lg hover:bg-[#00B9AF] transition-colors duration-200"
                aria-label="Toggle filters"
              >
                <Filter className="w-6 h-6 text-gray-400 hover:text-[#00B9AF]" />
              </button>
              <button
              ...
              >
                <Menu className="w-6 h-6 text-gray-400 hover:text-[#00B9AF]" />
              </button>
            </div>
          </nav>
        </div>
      ...
      <div
        className={`fixed top-0 left-0 h-full w-72 bg-white shadow-2xl z-50 transform transition-transform duration-300 ease-in-out lg:hidden overflow-y-auto ${
      ...
      >
        <div className="p-4">
          ...
          <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-100">
            <div className="flex items-center space-x-2">
              <Menu className="w-5 h-5 text-[#00B9AF]" />
              <h2 className="font-grotesk font-bold text-lg text-gray-800">
                Menu
              </h2>
            </div>
            <button
              onClick={closeAllMenus}
              className="p-1.5 hover:bg-[#00B9AF] rounded-full transition-colors duration-200"
            ...
            <ul className="space-y-2">
              <li>
                <ScrollLink
                  ...
                  duration={300}
                  onClick={closeAllMenus}
                  className="flex items-center px-3 py-2.5 text-gray-700 hover:text-[#00B9AF] hover:bg-[#00B9AF] rounded-lg transition-all duration-200 cursor-pointer mono-tag text-sm"
                >
                  Home
                </ScrollLink>
              </li>
          ...
          <div className="mb-6">
            ...
            <div className="space-y-2">
              <button className="w-full flex items-center px-3 py-2.5 text-gray-700 hover:text-[#4BCA7B] hover:bg-[#00B9AF] rounded-lg transition-all duration-200 text-sm">
                <LogIn className="w-4 h-4 mr-3 text-[#00B9AF]" />
                Sign In
              </button>
              <button className="w-full flex items-center px-3 py-2.5 text-gray-700 hover:text-[#00B9AF] hover:bg-[#00B9AF] rounded-lg transition-all duration-200 text-sm">
                <UserPlus className="w-4 h-4 mr-3 text-[#00B9AF]" />
                Sign Up
              </button>
            </div>
          </div>
